...
namespace Web.Filters
{
    public class LocalisationAttribute : ActionFilterAttribute
    {
        ...
        public const string CookieName = "Invesafe.CurrentUICulture";
        ...
        public override void OnActionExecuting(ActionExecutingContext filterContext)
        {
            ...
            if (string.IsNullOrEmpty(culture) || !CultureHelper.isCultureExist(culture))
            {
                ...
                else
                {
                    ...
                    culture = (filterContext.HttpContext.Request.UserLanguages == null) ? "en" : filterContext.HttpContext.Request.UserLanguages[0];
                }
